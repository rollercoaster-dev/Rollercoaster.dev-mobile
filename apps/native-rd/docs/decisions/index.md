...
| [ADR-0006](./ADR-0006-iteration-b-scope-amendment.md)   | Iteration B scope amendment — drop three orphans, add step-model enrichment | Accepted — Step-model enrichment scope superseded by [ADR-0010](./ADR-0010-phase-b-step-model-crosswalk.md); rest stands | 2026-05-23    |
