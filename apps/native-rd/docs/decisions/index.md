...
ADR-0013). Every PR that adds or accepts an ADR must update the Current
positions section below in the same PR.
...
| i18n                        | OpenRouter + Vercel AI SDK gateway; non-reasoning model pool; three-layer voice enforcement (register + intent sidecar + glossary).                                                                                                   | [ADR-0007](./ADR-0007-i18n-gateway.md), [0008](./ADR-0008-i18n-bakeoff-model-pool.md), [0009](./ADR-0009-i18n-voice-enforcement.md) |
...
| [ADR-0006](./ADR-0006-iteration-b-scope-amendment.md)      | Iteration B scope amendment — drop three orphans, add step-model enrichment  | Accepted, superseded by 0010        | 2026-05-23    |
...
| [ADR-0010](./ADR-0010-phase-b-step-model-crosswalk.md)     | Phase B step-model crosswalk                                                 | Accepted, consolidated into 0013    | 2026-06-08    |
| [ADR-0011](./ADR-0011-step-model-names.md)                 | Step-model names and letter consolidation — ten rows become seven features   | Proposed, restated in 0013          | 2026-06-12    |
| [ADR-0012](./ADR-0012-no-auto-judgment.md)                 | No-auto-judgment — reframe no-auto-state; allow auto-bookkeeping             | Proposed, restated in 0013          | 2026-06-14    |
