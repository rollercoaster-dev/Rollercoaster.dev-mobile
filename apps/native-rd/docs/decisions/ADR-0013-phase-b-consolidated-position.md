...
| **Scratchpad**      | One freeform pad (ink, images, text, fragments) absorbing per-step context and mid-work capture. Items drag out to become a substep, evidence, or note.                                | Nothing lands anywhere automatically — you drag it. Not evidence's register, not a review, no required flow.                         |
