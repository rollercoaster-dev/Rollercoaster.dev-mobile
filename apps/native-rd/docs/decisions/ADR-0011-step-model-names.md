...
the app, and consolidated the ten rows into seven things. This ADR records
...
> If Joe wouldn't say the word out loud to a friend describing the app, it
> doesn't go in the doc.
...
| D: Per-step context + F: Mid-work capture      | **Scratchpad**   | One surface absorbs both letters: a freeform pad (Apple Freeform / a mini Miro board) holding finger-written ink, images, text, fragments — anything. Everything on it is draggable: arranged within the pad, or dragged out to *become* something — a substep, evidence, a step note. F's open edge — where does captured structure land? — is answered: **nowhere automatically; you drag it.** D's and F's non-commitments (not evidence's register, not a review, no required flow) carry forward.                  |
...
- The prototype plan regroups its stages around the seven things.
