...
| Issue                                                | Why deferred                                                                                                                                                                                                              |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| #64 — stable testIDs                                 | Wave plan wanted this first to keep `git blame` clean across migrations. Shipping plan accepts the cost of test churn to move faster. Plan doc retained at `docs/plans/issue-64-i18n-testids.md` for when it reactivates. |
