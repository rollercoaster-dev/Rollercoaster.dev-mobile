...
| Item                                                                  | Why                                                                                                                                                                            | Owner                                                                     |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| **New `celebration-*` chrome token** (per-theme, contrast-validated)  | The band should be the prototype's celebration **yellow**, not purple `screenHeaderBg`. No yellow per-theme token exists; AC needs all-7-theme + zero-hex. (D1)                | Separate design-tokens PR — **blocks the band-colour swap in this issue** |
