...
| Not fixed | Dependabot's unconditional ignore also suppresses _security_ updates for unistyles.                                                                                                                                                                                                                      | Intentional (D5), consistent with the existing `react-native`/`reanimated` entries; documented inline in `dependabot.yml` so the trade is visible.                                                                                                      |
