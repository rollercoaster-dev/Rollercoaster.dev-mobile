...
| `apps/native-rd/src/badges/types.ts`                                      | `iconDuotoneOpacity?: number` + `parseBadgeDesign` manual sanitization branch (snaps in-range values to `BADGE_DUOTONE_OPACITY_STEP`)                                                                   | ~30            |
...
| Tests: `badges/__tests__/types.test.ts`                                   | Sanitization (preserve / snap-to-step / drop branches)                                                                                                                                                  | ~40            |
