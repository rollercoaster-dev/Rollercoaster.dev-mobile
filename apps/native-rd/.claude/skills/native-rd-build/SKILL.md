...
| Android preview APK            | n/a                                                        | `eas build -p android --profile preview`                 | `[UNTESTED]` first attempt 2026-05-07 errored in POST_INSTALL_HOOK (`bunx` missing on EAS Linux worker, see Gotcha 10); fix queued, retry pending                                                                             |
