...
export type GoalsScreenProps = NativeStackScreenProps<
  ...
  "Goals"
>;
export type FocusModeScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "FocusMode"
>;
export type NewGoalScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "NewGoal"
>;
export type EditModeScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "EditMode"
>;
export type CompletionFlowScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CompletionFlow"
>;
...
export type BadgesScreenProps = NativeStackScreenProps<
  ...
  "Badges"
>;
export type BadgeDetailScreenProps = NativeStackScreenProps<
  BadgesStackParamList,
  "BadgeDetail"
>;
export type BadgeDesignerScreenProps = NativeStackScreenProps<
  BadgesStackParamList,
  "BadgeDesigner"
>;
export type GoalsBadgeDesignerScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "BadgeDesigner"
>;
...
export type CapturePhotoScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CapturePhoto"
>;
export type CaptureVoiceMemoScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CaptureVoiceMemo"
>;
export type CaptureTextNoteScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CaptureTextNote"
>;
export type CaptureLinkScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CaptureLink"
>;
export type CaptureVideoScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CaptureVideo"
>;
export type CaptureFileScreenProps = NativeStackScreenProps<
  GoalsStackParamList,
  "CaptureFile"
>;
